...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["pictures"]) && $_FILES["pictures"]["error"] === 0) {
        ...
        // Insert property
        $sql = "INSERT INTO properties (type, address, city, state, zip_code, price, bedrooms, bathrooms, square_feet, year_built, description)
                        VALUES (:type, :address, :city, :state, :zip, :price, :bedrooms, :bathrooms, :squareFeet, :yearBuilt, :description)";
        ...
        $stmt->execute([
            ...
            ":imageUrl" => '/assets/homes/' . $propertyId . '/' . $imgName,
        ]);
    ...
    <body>
        ...
        <form action="create.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-wrapper" >
                ...
                <input type="text" id="year-built" name="year_built" >
            </div>
            <div class="input-wrapper" >
                <label for="address">
                    Address
